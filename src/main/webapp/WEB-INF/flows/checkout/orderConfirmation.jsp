...
<div class="container-wrapper">
    <div class="container">
        <div class="page-header">
            ...
            <p class="lead">Potvrda porudzbine</p>
        </div>
                    ...
                    <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 co-md-offset-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                                <p>Datum kupovine: <fmt:formatDate type="date" value="${now}"/></p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <address>
                                    <strong>Adresa racuna</strong><br>
                        ...
                        <br><br>
                        <button class="btn btn-default" name="_eventId_backToCollectShippingDetail">Nazad</button>
                        <input type="submit" value="Potvrdite porudzbinu" class="btn btn-default"
